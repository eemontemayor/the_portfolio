            ...
            <Split className='black' id='about-mob-img'  >
                ...
                <section className='about-text-container'>
                    <p className='about-text'>
                        I am a full-stack developer, based in Austin, Tx, with a background in philosophy and education.  Before enrolling in Thinkful's Engineering Immersion Program, I was teaching philosophy at the university level. Now, I am excited about this new phase in my life and eager to continue building on what I have already learned. 
                    </p>
                    <p className='about-text'>
